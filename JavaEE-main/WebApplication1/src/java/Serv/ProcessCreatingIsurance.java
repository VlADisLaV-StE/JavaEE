...
public class ProcessCreatingIsurance extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Integer summ = new Integer(request.getParameter("summa"));
            Integer idClient = new Integer(user.getValues().get("id"));
            ...
            if(q.insertAgreement(idClient,idAgent,summ,agentProcent )==1)
           {
                ...
                out.print("<h3>Ваше заявление принято!</h3>");
                out.print("<a style = \"background:blueviolet; color:white; text-decoration:none; padding: 1rem 1.5rem;\" href=\"WelcomeUser.jsp\"> Назад </a>");
           }
